...
class Api {
     ...
     */
    signup(userData) {
        return this.asyncRequest(`https://${this.host}:${this.port}/users`, 'POST', JSON.stringify(userData));
    }
     ...
     */
    login(userData) {
        return this.asyncRequest(`https://${this.host}:${this.port}/sessions`, 'POST', JSON.stringify(userData));
    }
     ...
     */
    logout() {
        return this.asyncRequest(`https://${this.host}:${this.port}/sessions`, 'DELETE');
    }
     ...
     */
    getUser(username) {
        return this.asyncRequest(`https://${this.host}:${this.port}/user/${username}`);
    }
     ...
     */
    getCurrentUser() {
        return this.asyncRequest(`https://${this.host}:${this.port}/users`);
    }
     ...
     */
    editUser(newData) {
        return this.asyncRequest(`https://${this.host}:${this.port}/users`, 'PUT', JSON.stringify(newData));
    }
    ...
    uploadAvatar(formData) {
        return this.asyncRequest(`https://${this.host}:${this.port}/users/avatar`, 'POST', formData,
            {
     ...
     */
    getMovieData(id) {
        return this.asyncRequest(`https://${this.host}:${this.port}/movies/${id}`);
    }
     ...
     */
    watchMovie(movieId) {
        return this.asyncRequest(`https://${this.host}:${this.port}/movies/${movieId}/watch`, 'POST');
    }
    ...
    unwatchMovie(movieId) {
        return this.asyncRequest(`https://${this.host}:${this.port}/movies/${movieId}/watch`, 'DELETE');
    }
    ...
    getMovieReviews(id, page=1) {
        return this.asyncRequest(`https://${this.host}:${this.port}/movies/${id}/reviews?page=${page}`);
    }
     ...
     */
    addReview(formData) {
        return this.asyncRequest(`https://${this.host}:${this.port}/users/reviews`, 'POST', JSON.stringify(formData));
    }
    ...
    getUserReviews(username) {
        return this.asyncRequest(`https://${this.host}:${this.port}/user/${username}/reviews`);
    }
    ...
    getUserReviewForMovie(id) {
        return this.asyncRequest(`https://${this.host}:${this.port}/users/movies/${id}/reviews`);
    }
    ...
    editUserReviewForMovie(formData) {
        return this.asyncRequest(`https://${this.host}:${this.port}/users/movies/${formData.movie_id}/reviews`, 'PUT', JSON.stringify(formData));
    }
    ...
    deleteUserReviewForMovie(id) {
        return this.asyncRequest(`https://${this.host}:${this.port}/users/movies/${id}/reviews`, 'DELETE');
    }
    ...
    addMovieRating(id, score) {
        return this.asyncRequest(`https://${this.host}:${this.port}/ratings`, 'POST', JSON.stringify({
            'movie_id': id,
            'score': score,
        }));
    }
    ...
    getUserRatingForMovie(id) {
        return this.asyncRequest(`https://${this.host}:${this.port}/ratings/${id}`);
    }
    ...
    editUserRatingForMovie(id, newScore) {
        return this.asyncRequest(`https://${this.host}:${this.port}/ratings`, 'PUT', JSON.stringify({
            'movie_id': id,
            'score': newScore,
        }));
    }
    ...
    deleteUserRatingForMovie(id) {
        return this.asyncRequest(`https://${this.host}:${this.port}/ratings/${id}`, 'DELETE');
    }
    ...
    getBestMovies(page=1) {
        return this.asyncRequest(`https://${this.host}:${this.port}/movies?category=best&page=${page}`);
    }
    ...
    getAllAvailableGenres() {
        return this.asyncRequest(`https://${this.host}:${this.port}/genres`);
    }
    ...
    getMoviesByGenres(genres, page=1) {
        return this.asyncRequest(`https://${this.host}:${this.port}/movies?category=genre&filter=${genres.join('+')}&page=${page}`);
    }
     ...
     */
    getActorData(id) {
        return this.asyncRequest(`https://${this.host}:${this.port}/actors/${id}`);
    }
     ...
     */
    likeActor(id) {
        return this.asyncRequest(`https://${this.host}:${this.port}/actors/${id}/like`, 'POST');
    }
     ...
     */
    unlikeActor(id) {
        return this.asyncRequest(`https://${this.host}:${this.port}/actors/${id}/like`, 'DELETE');
    }
    ...
    getPlaylistsForMovie(movieId) {
        return this.asyncRequest(`https://${this.host}:${this.port}/playlists/movies/${movieId}`);
    }
    ...
    getPlaylists(username) {
        return this.asyncRequest(`https://${this.host}:${this.port}/playlists/users/${username}`);
    }
    ...
    createPlaylist(name, isShared=false) {
        return this.asyncRequest(`https://${this.host}:${this.port}/playlists`, 'POST', JSON.stringify({
            'playlist_name': name,
            'is_shared': isShared,
        }));
    }
    ...
    addMovieToPlaylist(playlistId, movieId) {
        return this.asyncRequest(`https://${this.host}:${this.port}/playlists/${playlistId}/movie`, 'POST',
            JSON.stringify({
                'movie_id': movieId,
            }));
    }
    ...
    deleteMovieFromPlaylist(playlistId, movieId) {
        return this.asyncRequest(`https://${this.host}:${this.port}/playlists/${playlistId}/movie`, 'DELETE',
            JSON.stringify({
                'movie_id': movieId,
            }));
    }
     ...
     */
    followUser(username) {
        return this.asyncRequest(`https://${this.host}:${this.port}/subscriptions/${username}`, 'POST');
    }
    ...
    unfollowUser(username) {
        return this.asyncRequest(`https://${this.host}:${this.port}/subscriptions/${username}`, 'DELETE');
    }
    ...
    checkSubscription(username) {
        return this.asyncRequest(`https://${this.host}:${this.port}/subscriptions/${username}/check`);
    }
     ...
     */
    getFeed() {
        return this.asyncRequest(`https://${this.host}:${this.port}/feed`);
    }
}
